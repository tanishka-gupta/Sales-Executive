...
public class ActivityNewsArticles extends Activity {
...
//        ParseAnalytics.trackAppOpened(getIntent());
    ...
    WebChromeClient webChromeClient = new WebChromeClient() {
        ...
        public void onProgressChanged(WebView view, int progress) {
            ...
            ActivityNewsArticles.this.setProgress(progress * 1000);
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType){
            ...
            Toast.makeText(ActivityNewsArticles.this,"OPEN",Toast.LENGTH_LONG).show();
            try{
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg,
            ...
            Toast.makeText(ActivityNewsArticles.this,"OPEN T",Toast.LENGTH_LONG).show();
        ...
        public boolean onShowFileChooser(
            ...
            if (takePictureIntent.resolveActivity(ActivityNewsArticles.this.getPackageManager()) != null) {
	...
	/*	 public boolean onShowFileChooser(
        ...
        public Bitmap getDefaultVideoPoster() {
            if (ActivityNewsArticles.this == null) {
                return null;
            }

            return BitmapFactory.decodeResource(ActivityNewsArticles.this
        ...
        public void onShowCustomView(View view,
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                mOriginalSystemUiVisibility = ActivityNewsArticles.this.getWindow()
                        .getDecorView().getSystemUiVisibility();
            }
            mOriginalOrientation = ActivityNewsArticles.this.getRequestedOrientation();

            // 2. Stash the custom view callback
            mCustomViewCallback = callback;

            // 3. Add the custom view to the view hierarchy
            FrameLayout decor = (FrameLayout) ActivityNewsArticles.this.getWindow()
                    .getDecorView();
        ...
        public void onHideCustomView() {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                ActivityNewsArticles.this.getWindow().getDecorView()
                        .setSystemUiVisibility(mOriginalSystemUiVisibility);
            }
            ActivityNewsArticles.this.setRequestedOrientation(mOriginalOrientation);
